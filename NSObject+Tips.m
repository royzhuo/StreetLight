...
-(void)showTTip:(NSString *)string detail:(NSString *)detail  mode:(MBProgressHUDMode)mode{
...
{
    [[Tips_private sharedInstance] showTTip:string detail:nil mode:MBProgressHUDModeIndeterminate];
}
