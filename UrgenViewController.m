...
@interface UrgenViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)NSMutableArray *warns;
@property(nonatomic,assign)int pageNo;

@end

@implementation UrgenViewController
        ...
        if (responseObj) {
            ...
            if (isSuccess) {
                ...
                for (NSDictionary *dic in results) {
                    ...
                    //判断是不是紧急警告
                    if ([[dic valueForKey:@"alarmtype"]intValue]==1) {
